class OrganizationsController < ApplicationController
  ...
  def organization_params
    params.require(:organization).permit(:name, :logo, zoho_integration_attributes: [:auth_token, :account_id, :organization_id, :external_organization_id, :client_id, :client_secret, :redirect_uri], quickbooks_integration_attributes: [:auth_token])
  end
end
